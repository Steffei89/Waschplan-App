...
export const programNameInput = document.getElementById('program-name-input');
export const programDurationInput = document.getElementById('program-duration-input');
export const addProgramBtn = document.getElementById('add-program-btn');
export const programListContainer = document.getElementById('program-list-container');
